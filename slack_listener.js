...
try {
    ...
    url = config.global("flint_slack_bot").get("url")  // #demo on Slack url
    http_connector_name = config.global("flint_slack_bot").get('http_connector_name')
    method = config.global("flint_slack_bot").get('method')
